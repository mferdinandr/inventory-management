...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <InputPrimitive
      ...
      data-slot="input"
      className={cn(
        // h-10, bukan h-8: sama alasannya dengan Button — target sentuh dan
        // keterbacaan bagi pengguna lansia. `md:text-sm` baku dihapus supaya
        // teks isian tidak justru mengecil di layar besar.
